...
// Config-driven: all options come from src/data/orderConfig.js. Compact card-grid form →
  ...
  return (
    <div className="df-page">
      ...
      <div className="df-body">
        <button className="df-back" onClick={() => navigateBack('?page=start')}>← Back</button>
